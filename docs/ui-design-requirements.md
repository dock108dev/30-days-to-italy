# 30 Days to Italy UI design requirements
...
- Use `web/app/glass.css` for tokens and components. Default action accent is blue (#0969df); primary text is deep slate (#182338), secondary text #54647b.
