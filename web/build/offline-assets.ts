...
export const REQUIRED_AUDIO_COUNT = REQUIRED_ENCOUNTER_AUDIO_COUNT + REQUIRED_POCKET_DECK_AUDIO_COUNT;
...
export function renderServiceWorker(manifest: OfflineBuildManifest): string {
  return `/* Generated by scripts/build-offline.ts. Do not edit by hand. */
